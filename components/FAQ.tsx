      ...
      <div className="w-full">
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1" className=" my-4 py-2">
            <AccordionTrigger className="text-white hover:no-underline font-warsaw phone:text-[min(5vh,5vw)] smTablet:text-[min(3vh,4vw)] font-light tracking-wide">
              What &nbsp;&nbsp;is &nbsp;&nbsp;the &nbsp;&nbsp;Turnaround
              &nbsp;&nbsp;Time?
            </AccordionTrigger>
            <AccordionContent className="text-white/80 pb-6 pt-4 font-poppins font-light smLaptop:text-[min(2vh,2vw)] phone:text-md smTablet:text-lg leading-relaxed">
          ...
          <AccordionItem value="item-2" className="my-4 py-2">
            <AccordionTrigger className="text-white hover:no-underline text-start font-warsaw phone:text-[min(5vh,5vw)] smTablet:text-[min(3vh,4vw)]font-light tracking-wide">
              How &nbsp;&nbsp;do &nbsp;&nbsp;we &nbsp;&nbsp;Communicate?
            </AccordionTrigger>
            <AccordionContent className="text-white/80 pb-6 pt-4 font-poppins font-light smLaptop:text-[min(2vh,2vw)] phone:text-md smTablet:text-lg leading-relaxed">
              We believe communication plays a very vital role. We communicate
              over calls, google meets, WhatsApp, Intercom.
            </AccordionContent>
          </AccordionItem>

          <AccordionItem value="item-3" className="my-4 py-2">
            <AccordionTrigger className="text-white text-start hover:no-underline font-warsaw phone:text-[min(5vh,5vw)] smTablet:text-[min(3vh,4vw)]font-light tracking-wide">
              What &nbsp;&nbsp;is &nbsp;&nbsp;the &nbsp;&nbsp;Process
              &nbsp;&nbsp;of &nbsp;&nbsp;Working &nbsp;&nbsp;with
              &nbsp;&nbsp;You?
            </AccordionTrigger>
            <AccordionContent className="text-white/80 pb-6 pt-4 font-poppins font-light smLaptop:text-[min(2vh,2vw)] phone:text-md smTablet:text-lg leading-relaxed">
              ...
              preferably over a call. We then engage in thorough research,
              ideation, and iterative development, closely collaborating with
              you to incorporate instant feedback throughout the project..
            </AccordionContent>
          </AccordionItem>

          <AccordionItem value="item-4" className="my-4 py-2">
            <AccordionTrigger className="text-white hover:no-underline font-warsaw phone:text-[min(5vh,5vw)] smTablet:text-[min(3vh,4vw)]text-start font-light tracking-wide">
              What &nbsp;&nbsp;happens &nbsp;&nbsp;if &nbsp;&nbsp;I
              &nbsp;&nbsp;don&apos;t &nbsp;&nbsp;like &nbsp;&nbsp;the
              &nbsp;&nbsp;design?
            </AccordionTrigger>
          ...
          <AccordionItem value="item-5" className="my-4 py-2">
            ...
            <AccordionContent className="text-white/80 pb-6 pt-4 font-poppins font-light smLaptop:text-[min(2vh,2vw)] phone:text-md smTablet:text-lg leading-relaxed">
              ...
              technologies, we use Nextjs , Tailwind, ORM, Sanity.io, Nodejs etc
              to provide with the smooth functionality of the website.
            </AccordionContent>
          </AccordionItem>
